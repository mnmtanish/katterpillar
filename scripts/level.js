$(function () {
  ...
  LevelClass.prototype.load = function(levelName, callback) {
    var self = this;
    var path = '/assets/levels/'+levelName+'.json';
  ...
  LevelClass.prototype.onWin = function() {
    alert('Congratulations!');
  };


  LevelClass.prototype.onLose = function() {
    alert('Ooops!');
  };
